  ...
  return (
    <div className="flex flex-col h-full p-4">
        ...
        <>
          <div className="flex gap-2 mb-4">
            <button
              ...
              className={`flex-1 py-3 px-3 rounded-md text-base font-semibold border cursor-pointer transition-colors ${
          ...
          {cart.orderType === "dine_in" && (
            <input
              ...
              className="w-full px-3 py-3 border border-gray-300 rounded-md text-base mb-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          )}
        </>
      )}
      ...
      <div className="border-t pt-3 mt-3">
        <div className="flex items-center justify-between font-bold text-gray-800 text-lg mb-3">
          <span>Total</span>
        ...
        <button
          ...
          onClick={onSubmit}
          className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-300 text-white font-semibold rounded-md text-base transition-colors cursor-pointer disabled:cursor-not-allowed"
        >
