...
import { FloatButton, Card, Input, Button, Space, Typography, Spin, Select } from "antd";
...
export function AiChatWidget() {
  ...
  const { messages, sending, branches, selectedBranchId, setSelectedBranchId, sendMessage, resetChat } = useAiChat();
        ...
        >
          {branches.length > 1 && (
            <Select
              ...
              onChange={(value) => setSelectedBranchId(value === ALL_BRANCHES_VALUE ? undefined : value)}
              style={{ width: "100%", marginBottom: 8 }}
              options={[
                { value: ALL_BRANCHES_VALUE, label: t("allBranches") },
