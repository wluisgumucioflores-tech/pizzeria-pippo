-- ============================================================
-- 047_orders_notes.sql
-- Nota de venta opcional en el POS: el cajero puede escribir una
-- nota libre al cobrar (ej: "sin cebolla", "mesa 5", "para Juan").
-- Se ve en el tab "Pedidos del día" del POS y en el desglose de
-- cada orden en Reportes.
--
-- Requiere redefinir create_order_atomic (033, redefinida en 042
-- y 044) para que guarde la nota — se redefine completa acá.
-- ============================================================
...
BEGIN
  ...
  INSERT INTO orders (branch_id, cashier_id, total, daily_number, payment_method, payment_provider, order_type, notes, idempotency_key)
  VALUES (v_branch_id, v_cashier_id, v_total, v_daily_number, v_payment_method, v_payment_provider, v_order_type, v_notes, v_idempotency_key)
